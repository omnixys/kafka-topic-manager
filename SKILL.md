...
# kafka-topic-manager — Skill: Package Development

> Workflow for kafka-topic-manager (packages/ts/kafka-topic-manager). Execute this workflow before, during, and
...
- This package is published (`@omnixys/kafka-topic-manager`); consumers pin versions and rely on SemVer.
